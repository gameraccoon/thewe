...
TutorialWidgetAfterFirstCell::TutorialWidgetAfterFirstCell(Tutorial::WeakPtr tutorial)
	: TutorialWidget(tutorial)
{
}

TutorialWidgetAfterFirstCell* TutorialWidgetAfterFirstCell::create(Tutorial::WeakPtr tutorial)
{
	TutorialWidgetAfterFirstCell* ret = new TutorialWidgetAfterFirstCell(tutorial);
	if (ret && ret->init())
	{
		ret->autorelease();
	}
...
bool TutorialWidgetAfterFirstCell::init()
{
	...
	if (btnContinue)
	{
		btnContinue->addTouchEventListener(CC_CALLBACK_2(TutorialWidgetAfterFirstCell::OnContinueCallback, this));
