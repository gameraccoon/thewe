...
/*void RegionTestScene::visit(void)
{
...
/*void RegionTestScene::ccTouchesBegan(cocos2d::CCSet* touches, cocos2d::CCEvent* event)
{
...
void RegionTestScene::ccTouchesEnded(cocos2d::CCSet* touches, cocos2d::CCEvent* event)
{
	cocos2d::CCTouch *touch = (cocos2d::CCTouch *)touches->anyObject();
...
void RegionTestScene::ccTouchesMoved(cocos2d::CCSet* touches, cocos2d::CCEvent* event)
{
	cocos2d::CCTouch *touch = (cocos2d::CCTouch *)touches->anyObject();
