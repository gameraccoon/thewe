...
bool WorldLoader::LoadGameState(void)
{
	...
	if (profile)
	{
		// 1. Ќаходим корневую €чейку
		// 2. рекурсивно добавл€ем детей
...
bool WorldLoader::SaveGameState(void)
{
	...
	if (profile)
	{
		...
		// 2. создать и сохранить xml файл с именем save-@им€ профил€@-@какой по счету + 1@
		// 3. если удалось сохранить удал€ем предидущий.

		// ¬ременный код без транзакционного сохранени€.
